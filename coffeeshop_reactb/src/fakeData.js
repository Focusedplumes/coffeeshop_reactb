...
export const fakeMerchitemNames = [
    { id: 1, itemName: "Black Coffee 160z Bag", price: 8, imageUrl: 'https://github.com/bryanrigsby/imagesForCoffeeShopSite/blob/main/16ozBagBlackCoffee.jpeg?raw=true' },
    { id: 2, itemName: "Stanley Cup", price: 28, imageUrl: 'https://github.com/bryanrigsby/imagesForCoffeeShopSite/blob/main/tumbler.png?raw=true' },
    { id: 3, itemName: "Ceramic Cup", price: 6, imageUrl: 'https://github.com/bryanrigsby/imagesForCoffeeShopSite/blob/main/mug.png?raw=true' },
    { id: 4, itemName: "Logo Hat", price: 12, imageUrl: 'https://github.com/bryanrigsby/imagesForCoffeeShopSite/blob/main/trucker_hat.png?raw=true' },
    { id: 5, itemName: "Logo Tshirt", price: 19, imageUrl: 'https://github.com/bryanrigsby/imagesForCoffeeShopSite/blob/main/tshirt.jpeg?raw=true' },
    { id: 6, itemName: "Coffee Calendar", price: 3, imageUrl: 'https://github.com/bryanrigsby/imagesForCoffeeShopSite/blob/main/calendar.jpeg?raw=true' }
]